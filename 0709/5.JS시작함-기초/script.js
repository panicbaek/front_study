...
// 문자
// js에서는 문자(열)은 쌍따움표, 작은따움표, 빽팅 다 가능
let str1 = "abc";
let str2 = 'abc';
let str3 = `abc`;
...
// null값
// js에서 null은 존재하지 않음, 비어있다, 알수없다에 의미
let a = null;
...
// prrompt 메세지를 출력해주고 사용자에게 입력받는 창이 있고
// 확인과 취소버튼이 있음
// prompt('메세지', 초기값);
let result = Number( prompt('나이 입력해 주세요', ) ); 
// 형변환 - Number ( ) <- 괄호 안에 변수를 모든 수로 바꿈
console.log( typeof result );
console.log(result + 1);

// confirm 메세지를 출력해주고 확인, 취소 버튼이 있음
// 확인을 누르면 true, 취소를 누르면 false가 리턴됨
let re = confirm("접속 하시겠습니까?")
console.log( re );
